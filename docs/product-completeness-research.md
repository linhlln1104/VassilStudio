...
| Transcribe | Upload/preview, queued ASR, timed segments when available, synchronized playback, revision-protected editing, TXT/SRT/VTT/JSON export, Generate handoff | Multi-file batch, optional speaker/channel metadata | P2 |
