...
| 2026-08-24 | Voice Intake Quality Gate P1-C | Done | Reviewed upload/local/microphone intake, trim-aware signal report and playback, transcript/language checks, canonical duplicate guard, desktop/mobile Playwright QA, real VI runtime probe, and `scripts/check.ps1` with 170 tests |
